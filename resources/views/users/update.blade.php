...
@section('content')
    <div>
        {{ Form::open(array('url' => '/user/' .$user->id .'/update', 'class' => 'align-self-center','method' => 'put'))}}
                ...
                <div class="row" >
                    @if(!$i)
                        <div class="form-group col-md-11">
                            ...
                            <input type="text" class="form-control" name="phones[]" value="{{$phone->phone}}" id="inputPhone" placeholder="Enter phone" required><br/>
                        </div>
                        <div class="col-md-1">
                    ...
                    @else
                        <div class="form-group col-md-11">
                            <label for="inputPhone">Phone  {{$i+1}} </label>
